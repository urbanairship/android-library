...
class AppStoreUtilsTest {
    ...
    fun testAmazonIntent() {
        val intent = AppStoreUtils.getAppStoreIntent(context, UAirship.Platform.AMAZON, emptyConfig)
    ...
    fun testAndroidIntent() {
        val intent = AppStoreUtils.getAppStoreIntent(context, UAirship.Platform.ANDROID, emptyConfig)
        Assert.assertEquals(
    ...
    fun testOverrideUri() {
        ...
        val intent = AppStoreUtils.getAppStoreIntent(context, UAirship.Platform.ANDROID, configOptions)
