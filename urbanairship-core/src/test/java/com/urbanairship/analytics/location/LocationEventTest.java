...
public class LocationEventTest extends BaseTestCase {
    ...
    @Test
    public void testRequestedAccuracy() {
    ...
    @Test
    public void testContinousUpdateType() {
    ...
    @Test
    public void testChangeUpdateType() {
