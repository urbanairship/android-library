...
public class ContactApiClientTest extends BaseTestCase {
    ...
    public void setUp() {
        ...
        client = new ContactApiClient(runtimeConfig, requestSession);
    }
    ...
    public void testResolveSucceeds() throws RequestException, JsonException {
        requestSession.addResponse(200, "{ \"ok\": true, \"contact_id\": \"fake_contact_id\", \"is_anonymous\": true }");
        ...
        assertEquals("POST", requestSession.getRequests().get(0).getMethod());
        assertEquals("https://example.com/api/contacts/resolve/", requestSession.getLastRequest().getUrl().toString());
    ...
    public void testIdentifySucceeds() throws RequestException, JsonException {
        requestSession.addResponse(200, "{ \"ok\": true, \"contact_id\": \"fake_contact_id\"}");
        ...
        assertEquals("https://example.com/api/contacts/identify/", requestSession.getLastRequest().getUrl().toString());
        assertEquals(new RequestBody.Json(expected), requestSession.getLastRequest().getBody());
        assertEquals("fake_contact_id", response.getResult().getContactId());
    ...
    public void testRegisterOpenChannelSucceeds() throws RequestException, JsonException {
        ...
        String expectedChannelPayload = "{\n" +
                ...
                "   }\n" +
                "}";
        Request registerRequest = requestSession.getRequests().get(0);
        ...
        assertEquals(new RequestBody.Json(JsonValue.parseString(expectedChannelPayload)), registerRequest.getBody());
        ...
        Request associateRequest = requestSession.getRequests().get(1);
        assertEquals("POST", associateRequest.getMethod());
        assertEquals("https://example.com/api/contacts/fake_contact_id", associateRequest.getUrl().toString());
        assertEquals(new RequestBody.Json(JsonValue.parseString(expectedUpdatePayload)), associateRequest.getBody());
    }
    ...
    public void testResetSucceeds() throws RequestException, JsonException {
        ...
        assertEquals(200, response.getStatus());
        assertEquals("POST", requestSession.getLastRequest().getMethod());
        assertEquals("https://example.com/api/contacts/reset/", requestSession.getLastRequest().getUrl().toString());
        assertEquals(new RequestBody.Json(expected), requestSession.getLastRequest().getBody());
        assertEquals("fake_contact_id", response.getResult().getContactId());
    ...
    public void testUpdateSucceeds() throws RequestException, JsonException {
        requestSession.addResponse(200, "{ \"ok\": true, \"tag_warnings\": \"The following tag groups do not exist: random-tag-group\", \"attribute_warnings\": \"Unable to process attribute change for attribute: 'random-attribute'. Attribute not found.\"}");
        ...
        assertEquals(200, response.getStatus());
        assertEquals("POST", requestSession.getLastRequest().getMethod());
        assertEquals("https://example.com/api/contacts/fake_contact_id", requestSession.getLastRequest().getUrl().toString());
        assertEquals(new RequestBody.Json(expected), requestSession.getLastRequest().getBody());
    }
    ...
    public void testGetSubscriptionLists() throws RequestException {
        ...
        assertEquals("https://example.com/api/subscription_lists/contacts/identifier", requestSession.getLastRequest().getUrl().toString());
