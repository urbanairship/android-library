...
public class LayoutEventMessageIdTest {
    ...
    public fun testLegacy() {
        val messageID = LayoutEventMessageId.Legacy(scheduleID)
    ...
    public fun testAppDefined() {
        val messageID = LayoutEventMessageId.AppDefined(scheduleID)
        val json = """
            {
    ...
    public fun testAirshipNoCampaigns() {
        val messageID = LayoutEventMessageId.AirshipId(scheduleID, campaigns = null)
        val json = """
            {
              "message_id":"$scheduleID"
            }
