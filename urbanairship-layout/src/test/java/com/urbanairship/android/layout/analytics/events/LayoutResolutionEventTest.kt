...
public class LayoutResolutionEventTest {
    @Test
    public fun testButtonResolution() {
        val event = LayoutResolutionEvent.buttonTap(
    ...
    public fun testMessageTap() {
        val event = LayoutResolutionEvent.messageTap(100_000.milliseconds)
        val expected = """
            {
               "resolution": {
                   "display_time":"100.00",
    ...
    public fun testUserDismissed() {
        val event = LayoutResolutionEvent.userDismissed(100_000.milliseconds)
        val expected = """
            {
               "resolution": {
                  "display_time":"100.00",
    ...
    public fun testTimedOut() {
        val event = LayoutResolutionEvent.timedOut(100000.milliseconds)
        val expected = """
            {
               "resolution": {
                  "display_time": "100.00",
    ...
    public fun testControl() {
        ...
        val event = LayoutResolutionEvent.control(experiment)
