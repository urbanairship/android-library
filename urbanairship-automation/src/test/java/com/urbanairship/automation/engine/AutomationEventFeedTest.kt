...
public class AutomationEventFeedTest {
    ...
    public fun testAnalyticFeedEvents(): TestResult = runTest {
        ...
        val eventMap = mapOf(
            ...
            EventType.LAYOUT_BUTTON_TAP to listOf(EventAutomationTriggerType.LAYOUT_BUTTON_TAP),
            EventType.LAYOUT_PERMISSION_RESULT to listOf(EventAutomationTriggerType.LAYOUT_PERMISSION_RESULT),
            EventType.LAYOUT_FORM_DISPLAY to listOf(EventAutomationTriggerType.LAYOUT_FORM_DISPLAY),
            EventType.LAYOUT_FORM_RESULT to listOf(EventAutomationTriggerType.LAYOUT_FORM_RESULT),
            EventType.LAYOUT_GESTURE to listOf(EventAutomationTriggerType.LAYOUT_GESTURE),
            EventType.LAYOUT_PAGER_COMPLETED to listOf(EventAutomationTriggerType.LAYOUT_PAGER_COMPLETED),
            EventType.LAYOUT_PAGER_SUMMARY to listOf(EventAutomationTriggerType.LAYOUT_PAGER_SUMMARY),
            EventType.LAYOUT_PAGE_SWIPE to listOf(EventAutomationTriggerType.LAYOUT_PAGE_SWIPE),
            EventType.LAYOUT_PAGE_VIEW to listOf(EventAutomationTriggerType.LAYOUT_PAGE_VIEW),
            EventType.LAYOUT_PAGE_ACTION to listOf(EventAutomationTriggerType.LAYOUT_PAGE_ACTION)
        )
