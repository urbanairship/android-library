...
public class InAppMessageContentValidationTest {
    ...
    public fun setup() {
        ...
        validButtonLabel = InAppMessageTextInfo(text = validText, color = validColor, size = 10F, fontFamilies = validFontFam, style = listOf(InAppMessageTextInfo.Style.BOLD))
        ...
        emptyButtonLabel = InAppMessageTextInfo(text = "", color = validColor, size = 10F, fontFamilies = validFontFam, style = listOf(InAppMessageTextInfo.Style.BOLD))
