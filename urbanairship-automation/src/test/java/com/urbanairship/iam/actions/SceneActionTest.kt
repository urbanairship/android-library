...
public class SceneActionTest {
    ...
    @Test
    public fun testPerform_invalidDeflateReturnsError() {
    ...
    /** Matches backend `encodeRawDeflateBase64` (BEST_COMPRESSION, nowrap, standard Base64). */
    private fun rawDeflateBase64(json: String): String {
        val deflater = Deflater(Deflater.BEST_COMPRESSION, true)
        val baos = ByteArrayOutputStream()
        DeflaterOutputStream(baos, deflater).use { it.write(json.toByteArray(Charsets.UTF_8)) }
