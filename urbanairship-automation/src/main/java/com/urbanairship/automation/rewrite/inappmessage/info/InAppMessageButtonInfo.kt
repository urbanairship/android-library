    ...
    public companion object {
        ...
        public fun fromJson(source: JsonValue): InAppMessageButtonInfo {
            ...
            return InAppMessageButtonInfo(
                ...
                label = content.require(LABEL_KEY).let(InAppMessageTextInfo::fromJson),
                behavior = content.get(BEHAVIOR_KEY)?.let(Behavior::fromJson),
                borderRadius = content.opt(BORDER_RADIUS_KEY).getFloat(0F),
                borderColor = content.get(BORDER_COLOR_KEY)?.let(InAppMessageColor::fromJson),
