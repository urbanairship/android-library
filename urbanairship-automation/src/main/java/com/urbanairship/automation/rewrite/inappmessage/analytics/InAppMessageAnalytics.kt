    ...
    private companion object {
        fun makeMessageID(message: InAppMessage, scheduleID: String, campaigns: JsonValue?): InAppEventMessageID {
            return when(message.source ?: InAppMessage.InAppMessageSource.REMOTE_DATA) {
                InAppMessage.InAppMessageSource.REMOTE_DATA -> InAppEventMessageID.AirshipID(scheduleID, campaigns)
                InAppMessage.InAppMessageSource.APP_DEFINED -> InAppEventMessageID.AppDefined(scheduleID)
