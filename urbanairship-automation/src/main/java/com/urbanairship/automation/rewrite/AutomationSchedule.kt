...
import com.urbanairship.automation.rewrite.deferred.isInAppMessage
        ...
        internal companion object {
            ...
            internal fun fromJson(value: JsonValue): ScheduleData {
                ...
                return when (ScheduleType.fromJson(content.require(TYPE))) {
                    ...
                    ScheduleType.IN_APP_MESSAGE -> InAppMessageData(InAppMessage.parseJson(content.require(MESSAGE)))
                    ScheduleType.DEFERRED -> Deferred(DeferredAutomationData.fromJson(content.require(DEFERRED)))
                }
            }
        }
    ...
    internal companion object {
        ...
        fun fromJson(value: JsonValue): AutomationSchedule {
            ...
            return AutomationSchedule(
                ...
                triggers = content.require(TRIGGERS).requireList().map(AutomationTrigger::fromJson),
                ...
                delay = content.get(DELAY)?.let(AutomationDelay::fromJson),
