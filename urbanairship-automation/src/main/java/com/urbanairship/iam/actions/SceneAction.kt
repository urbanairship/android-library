...
import com.urbanairship.util.zlibInflate
 ...
 *
 * Accepted argument values: A JSON object containing a "scene" field with
 * an [com.urbanairship.iam.content.AirshipLayout].
 *
 * Result value: `null`
 *
...
public class SceneAction(
    ...
    public companion object {
        ...
        private const val QUEUE = "scene_page"
