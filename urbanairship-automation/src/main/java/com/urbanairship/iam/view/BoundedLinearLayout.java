...
public class BoundedLinearLayout extends LinearLayout {
     ...
     */
    public BoundedLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
     ...
     */
    public BoundedLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public BoundedLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle, int defResStyle) {
