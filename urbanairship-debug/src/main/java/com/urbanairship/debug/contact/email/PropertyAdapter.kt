...
class PropertyAdapter(private val callback: ((property: Pair<String, JsonValue>) -> Unit)) : ListAdapter<Pair<String, JsonValue>,
        PropertyAdapter.ViewHolder>(PropertyAdapter.PropertyFilterDiff()) {
